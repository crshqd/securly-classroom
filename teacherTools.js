...
const t = "respondToShareScreen";
const n = "sendMessage";
const s = "teacherMessage";
const o = "clearTabsCloseWarning";
const a = "action";
const l = "announce";
const i = "announceTitle";
const c = "chat";
const d = "forceOpenChat";
const r = "forceCloseChat";
const m = "chatMessages";
const p = "tabsCloseWarning";
const g = "command";
const y = "lock";
const u = "chatMessage";
const h = "date";
const f = "isFromTeacher";
const v = "teacherName";
const M = "text";
const x = "tabCloseWarning";
const w = "delaySeconds";
const E = "chatStatus";
const L = "lockStatus";
const C = "requestShareScreen";
const b = ["kidsa-z.com/main/Login"];
let B = false;
let S = false;
let A = 0;
var I = null;
chrome.runtime.onMessage.addListener(function (e, t, n) {
  ...
  T("tpIcofont", "icofont.css")
    ...
    .then(() => {
      ...
      const m = e[l];
      if (typeof m == "string") {
        const t = { timeStyle: "short", hour12: true };
        const n = new Date().toLocaleTimeString("en-US", t);
      ...
      if (typeof f == "string") {
        document.getElementById("tpMsgTable").style.display = "table";
        document.getElementById("tpConfirmTable").style.display = "none";
        document.getElementById("blocked_message").innerHTML = f;
        document.getElementById("tpScreenLockCover").style.display = "flex";
      }
      if (e[g] === E) {
        if (e[c]) {
          if (!B) {
...
function k(e) {
  ...
  if (e.indexOf(l) !== -1 && e.indexOf(p) !== -1) {
    document.getElementById("tpAnnouncementMessage").innerHTML = "";
...
async function Z(e, t) {
  ...
  while (s.children.length > 0) {
    document.body.appendChild(s.children[0]);
  }
  console.log("HTML " + e + " injected");
  I = new G();
}
function H(e) {
...
function j() {
  ...
  if (e.value.trim().length > 0) {
    chrome.runtime.sendMessage({ [g]: n, [a]: c, [M]: e.value });
    J(e.value, false, "You", new Date().toUTCString());
    e.value = "";
  }
}
function D(e, n) {
...
function _() {
  ...
  document.getElementById("chatPanel").classList.toggle("visible", true);
  document.getElementsByTagName("body")[0].classList.toggle("noOverflow", true);
}
function U() {
  document.getElementById("chatPanel").classList.toggle("toHidden", true);
  document.getElementById("chatPanel").classList.toggle("visible", false);
  document
    .getElementsByTagName("body")[0]
    .classList.toggle("noOverflow", false);
}
function J(e, t, n = "", s) {
  let o =
    '<div class="group"><div class="messageDetails @receiver@">' +
    '<span class="messageDetails-name">@name@</span><span class="messageTime">@time@</span></div>' +
    '<div class="message @receiver@">@text@</div></div>';
  if (t) {
    o = o.replace(/@receiver@/g, "toMe");
  } else {
    o = o.replace(/@receiver@/g, "mine");
  }
  o = o.replace("@time@", Y(s));
  o = o.replace("@text@", W(K(e)));
  o = o.replace("@name@", n);
...
function Y(e) {
  const t = new Date(e);
  const n =
    t.getHours() === 0 ? 0 : t.getHours() % 12 === 0 ? 12 : t.getHours() % 12;
  const s = n < 10 ? "0" + n.toString() : n.toString();
  const o =
    t.getMinutes() < 10
  ...
  return s + ":" + o + ":" + a + (t.getHours() - 12 < 0 ? " AM" : " PM");
}
function X(e) {
  ...
  e.forEach((e) => J(e[M], e[f], e[f] ? e[v] : "You", e[h]));
  F();
}
function F() {
...
class G {
  ...
  generateElements(e) {
    ...
    const n = (e) => {
      ...
      a.style.display = "block";
      var t = a.querySelectorAll("ul"),
        n = 1,
        s = t.length;
      for (n; n < s; n++) {
        t[n].style.display = "none";
      }
      var o = a.querySelectorAll(".category div");
      (n = 0), (s = o.length);
      for (n; n < s; n++) {
        o[n].style.background = "none";
      }
    ...
    g.style.width = "100%";
    g.style.background = "#eff0f1";
    g.style.listStyle = "none";
    ...
    const v = [
      ...
      127942, 127944, 127946, 128675, 128692, 128693, 9917, 9918, 9978, 127907,
      127919, 9971,
    ];
    const M = [
    ...
    y.map((e) => {
      ...
      t.id = String(e["name"]);
      if (String(e["name"]) == "faces") {
        t.style.background = "#c2c2c2";
      }
    ...
    x.map((e) => {
      ...
      s.innerHTML = String.fromCodePoint(e);
      s.onmousedown = t;
      p.appendChild(s);
    });
    a.appendChild(g);
    ...
    window.addEventListener("click", function (t) {
      if (!e.hasAttribute("data-meteor-emoji-large")) {
        if (I.stopClickEvent) {
          I.stopClickEvent = false;
          return;
        }
        if (a.style.display === "block") {
          if (!a.contains(t.target) && !l.contains(t.target)) {
            a.style.display = "none";
          }
        }
      }
